  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        artistic: "rounded-full uppercase transition-all duration-300",
        artisticPrimary: "rounded-full uppercase transition-all duration-300 border border-[var(--c-charcoal)] hover:bg-transparent",
        artisticSecondary: "rounded-full uppercase bg-transparent border-transparent opacity-70 hover:opacity-100 transition-all duration-300",
      },
      size: {
        ...
        icon: "h-9 w-9",
        artistic: "h-12 px-8 text-[11px] tracking-[1.5px]",
      },
    },
    defaultVariants: {
      variant: "default",
